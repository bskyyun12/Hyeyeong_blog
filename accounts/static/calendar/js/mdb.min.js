                        ...
                        draw: function(t) {
                            ...
                            if (o.display) {
                                ...
                                if (a.each(g, function(i, n) {
                                    ...
                                    var D, E, L = 0,
                                        R = r(p) / 2;
                                    if (m) D = e.left + (e.right - e.left) / 2, E = "bottom" === o.position ? e.bottom - R - C.bottom : e.top + R + C.top;
                                    else {
                ...
                e.exports = function(t) {
                    var e = t.Scale.extend({
                        ...
                        determineDataLimits: function() {
                            ...
                            for (t = 0, i = (p.data.datasets || []).length; t < i; ++t)
...
(t => {
    ...
    function(t) {
        function e() {
            const e = Number(t(this).attr("length")),
...
$(".smooth-scroll").on("click", "a", function() {
        ...
        if (void 0 !== t && 0 === t.indexOf("#")) {
            ...
            }, 700), void 0 !== i && !1 !== i && history.replaceState(null, null, t), !1
        }
    }),
    function(t) {
...
dropdownSelectors.on({
            ...
            return this.each(function() {
                new class {
                    ...
                    panendEventHandler(t) {
                        if ("touch" !== t.gesture.pointerType) return;
                        const e = t.gesture.velocityX,
                            i = t.gesture.center.x;
                        let c = i - this.options.MENU_WIDTH,
                    ...
                    openOnClick() {
                        this.$element.on("click", e => {
                            if (e.preventDefault(), !0 === this.menuOut) this.menuOut = !1, this.removeMenu();
                            else {
                                this.$sidenavOverlay = t('<div id="sidenav-overlay"></div>'), this.$body.append(this.$sidenavOverlay);
                                let e = [];
                                e = "left" === this.options.edge ? [0, -1 * this.options.MENU_WIDTH] : [0, this.options.MENU_WIDTH], this.$menu.velocity({
                                    translateX: e
                                }, {
                                    duration: 300,
                                    queue: !1,
                    ...
                    setMenuTranslation() {
                        "left" === this.options.edge ? (this.$menu.css("transform", "translateX(-100%)"), this.$dragTarget.css({
                            ...
                            right: 0
                        })), this.$menu.hasClass("fixed") && (window.innerWidth > i && this.$menu.css("transform", "translateX(0)"), t(window).resize(() => {
                            if (window.innerWidth > i) this.$sidenavOverlay.length ? this.removeMenu(!0) : this.$menu.css("transform", "translateX(0%)");
                            else if (!1 === this.menuOut) {
        ...
        class e {
            ...
            buildMaterialOptions() {
                this.$nativeSelectChildren.each((e, i) => {
                    const n = t(i);
                    if (n.is("option")) this.buildSingleOption(n, this.isMultiple ? "multiple" : "");
            ...
            buildSingleOption(e, i) {
                const n = e.is(":disabled") ? "disabled" : "",
            ...
            _triggerChangeOnNativeSelect() {
                const t = new KeyboardEvent("change", {
                    bubbles: !0,
                    cancelable: !0
                });
            ...
            _onToggleAllClick() {
                const e = t(this.$toggleAll).find('input[type="checkbox"]').first(),
                    i = !t(e).prop("checked");
            ...
            _toggleSelectedValue(t) {
                const e = this.valuesSelected.indexOf(t),
                    i = -1 !== e;
    ...
    function(t, e) {
        ...
        return function(t, e, i, n) {
            ...
            o.extend(r, n);
            var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, S, C, T, M, I, P, A, _, O, D, E, L, R, F, $, W, V, z, N, H, j, B, Y, X, q, U, Q, Z, K, G, J, tt, et, it, nt, ot, at, rt, st, lt = {
                    x: 0,
                    y: 0
                },
                ct = {
                ...
                Ae = function(t) {
                    ...
                    var c = -1;
                    if (0 === l && (B = !1, o.unbind(window, p, a), pe(), K ? c = 0 : -1 !== le && (c = Tt() - le)), le = 1 === l ? Tt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", K && 2 > l && (K = !1, 1 === l && (n = "zoomPointerUp"), Ct("zoomGestureEnded")), Z = null, q || X || et || H)
            ...
            return this.$el = t(this), this.$document = t(document), this.eventsHandled = !1, this.defaultOptions = {
                ...
                this.$document.on("click", this.selectors.chips, e => {
                    ...
                    const i = this.$document.find(this.selectors.chip + this.selectors.selectedChip),
                        n = i.closest(this.selectors.chips),
                        o = i.siblings(this.selectors.chip).length;
                    if (!i.length) return;
                    const a = e.which === this.keyCodes.backspace,
                        r = e.which === this.keyCodes.delete,
                        s = e.which === this.keyCodes.arrowLeft,
                        l = e.which === this.keyCodes.arrowRight;
                    ...
                    if (e.which === this.keyCodes.enter) return e.preventDefault(), this.addChip(o, {
                        tag: i.val()
                    }, n), void i.val("");
